...
function plot(options, selection, library, context) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        selection
            ...
            plotView(view, (0, selection_1.select)(element), transitions, library, context);
        ...
        const viewInstanceof = (viewContainer) => {
            return Array.from(viewContainer.entries()).map(([view, container]) => {
                ...
                const update = createUpdateView((0, selection_1.select)(container), library, context);
                ...
                return {
                    ...
                    options,
                    setState,
                    update: () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        return yield update(newOptions);
                    }),
                };
            });
        };
...
function updateTooltip(selection, options, view, library, context) {
    ...
    const applyTooltip = useThemeInteraction(view, 'tooltip', tooltipOptions[1], useInteraction);
    const target = {
        options,
        view,
        ...
        while (discovered.length) {
            ...
            if (staticMarks.has(type))
                ...
                if (!composite)
                    ...
                    const marks = yield useMark(newMark, context);
...
function initializeMarks(options, library) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const markOptions of partialMarks) {
            ...
            const { props = {} } = createMark(type);
            const markAndState = yield (0, mark_1.initializeMark)(markOptions, props, library);
            if (markAndState) {
...
function createMarkShapeFunction(mark, state, view, library, context) {
    ...
    return (data) => {
        ...
        const visualStyle = (0, array_1.mapObject)(style, (d) => valueOf(d, abstractDatum, I, abstractData));
...
function inferInteraction(view) {
    ...
    return Object.entries((0, util_1.deepMix)(defaults, interaction));
}
