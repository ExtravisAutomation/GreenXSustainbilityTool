...
export type EncodeFunction = (data: Record<string, MaybeArray<Primitive>>[]) => MaybeArray<Primitive>[];
...
export type GuidePrimitivePosition = 'top' | 'bottom' | 'left' | 'right' | 'center' | 'inner' | 'outer';
export type GuideCompositePosition = 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
export type GuideComponentPosition = GuidePrimitivePosition | GuideCompositePosition;
