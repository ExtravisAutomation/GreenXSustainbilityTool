...
import { appendTransform, compose, copyAttributes, defined, error, maybeSubObject, subObject, useMemo, } from '../utils/helper';
...
import { applyScale, assignScale, collectScales, inferScale, syncFacetsScales, useRelationScale, } from './scale';
...
function initializeMarks(options, library) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const channels of scaleChannels.values()) {
            ...
            const scale = Object.assign(Object.assign({}, inferScale(name, values, options, coordinates, theme, library)), { key: scaleKey });
