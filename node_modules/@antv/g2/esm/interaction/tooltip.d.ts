 ...
 */
export declare function seriesTooltip(root: DisplayObject, { elements: elementsof, sort: sortFunction, filter: filterFunction, scale, coordinate, crosshairs, render, groupName, emitter, wait, leading, trailing, startX, startY, body, single, position, enterable, mount, bounding, theme, disableNative, marker, preserve, style: _style, css, ...rest }: Record<string, any>): () => void;
/**
...
single, position, enterable, datum, view, mount, bounding, theme, shared, body, disableNative, preserve, css, }: Record<string, any>): () => void;
