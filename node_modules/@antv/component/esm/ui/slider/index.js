...
var Slider = /** @class */ (function (_super) {
    ...
    Slider.prototype.renderTrack = function (container) {
        ...
        this.trackShape = select(container)
            ...
            .styles(__assign(__assign({}, this.shape), style));
    };
    Slider.prototype.renderBrushArea = function (container) {
        ...
        this.brushArea = select(container)
            ...
            .styles(__assign({ fill: 'transparent', cursor: brushable ? 'crosshair' : 'default' }, this.shape));
    };
    ...
    Slider.prototype.getHandleStyle = function (handleType) {
        ...
        return __assign(__assign(__assign(__assign({}, superStyleProps(this.getHandleIconStyle(), 'icon')), superStyleProps(__assign(__assign({}, this.getHandleLabelStyle(handleType)), textStyle), 'label')), handlePosition), { orientation: orientation, showLabel: internalShowLabel, type: handleType, zIndex: 3 });
    };
