...
var Continuous = /** @class */ (function (_super) {
    ...
    Continuous.prototype.render = function (attributes, container) {
        ...
        /** label */
        /** content */
        var contentGroup = select(container).maybeAppendByClassName(CLASS_NAMES.contentGroup, 'g').styles({ x: x, y: y });
    ...
    Continuous.prototype.adjustTitle = function () {
        ...
        var _b = __read(this.getElementsByClassName(CLASS_NAMES.title.name), 1), title = _b[0];
