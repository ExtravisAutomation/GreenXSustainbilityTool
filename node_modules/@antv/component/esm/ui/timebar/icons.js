...
var IconBase = /** @class */ (function (_super) {
    ...
    IconBase.prototype.renderBackground = function () {
        ...
        this.background.attr(__assign({ x: -halfSize, y: -halfSize, width: size, height: size }, backgroundStyle));
    };
...
var LineChart = /** @class */ (function (_super) {
    ...
    LineChart.prototype.renderIcon = function () {
        ...
        var _b = __read([-size / 2 + gap, size / 2 - gap * 2], 2), ox = _b[0], oy = _b[1];
        select(this.icon)
...
var BarChart = /** @class */ (function (_super) {
    ...
    BarChart.prototype.renderIcon = function () {
        ...
        var _b = __read([-size / 2 + gap * 2, size / 2 - gap], 2), ox = _b[0], oy = _b[1];
        select(this.icon)
            .maybeAppend('.coordinate', 'polyline')
            .styles({
            points: getCoordinatePoints(size),
...
var SpeedSelect = /** @class */ (function (_super) {
    ...
    SpeedSelect.prototype.renderIcon = function () {
        ...
        var inheritStyle = omit(this.attributes, ['x', 'y', 'width', 'height', 'size', 'color', 'speed']);
        var width = clamp(iconSize, 20, Infinity);
        var height = 20;
        var x = -width / 2;
        var y = -height / 2;
        var style = __assign(__assign({}, inheritStyle), { x: x, y: y, width: width, height: height, defaultValue: speed, bordered: false, showDropdownIcon: false, selectRadius: 2, dropdownPadding: this.padding, dropdownRadius: 2, dropdownSpacing: iconSize / 5, placeholderFontSize: iconSize / 2, optionPadding: 0, optionLabelFontSize: iconSize / 2, optionBackgroundRadius: 1, options: [
                { label: '1x', value: 1 },
...
var ToggleIcon = /** @class */ (function (_super) {
    ...
    ToggleIcon.prototype.render = function () {
        var _this = this;
        var _a = this.attributes, x = _a.x, y = _a.y, onChange = _a.onChange, restStyles = __rest(_a, ["x", "y", "onChange"]);
        select(this.icon)
            .selectAll('.icon')
