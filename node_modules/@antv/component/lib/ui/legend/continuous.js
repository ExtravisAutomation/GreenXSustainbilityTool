...
var Continuous = /** @class */ (function (_super) {
    ...
    Continuous.prototype.adjustTitle = function () {
        var _a = this.attributes, titlePosition = _a.titlePosition, orientation = _a.orientation;
        var _b = tslib_1.__read(this.getElementsByClassName(constant_2.CLASS_NAMES.title.name), 1), title = _b[0];
        ...
        if (titlePosition !== 'top-left' || orientation !== 'horizontal')
            return;
        var _c = tslib_1.__read(handle.getLocalBounds().min, 1), handleX = _c[0];
        var _d = tslib_1.__read(title.getLocalBounds().min, 1), titleX = _d[0];
    ...
    Continuous.prototype.setHandlePosition = function (type, value) {
        ...
        handle === null || handle === void 0 ? void 0 : handle.update({ x: x, y: y, formatter: handleFormatter });
    };
    ...
    Object.defineProperty(Continuous.prototype, "labelAxisStyle", {
        get: function () {
            ...
            return { offset: offset, spacing: labelSpacing, tickLength: tickLength };
        },
        enumerable: false,
        configurable: true
    });
