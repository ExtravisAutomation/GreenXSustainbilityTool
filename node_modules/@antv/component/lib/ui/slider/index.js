...
var Slider = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Slider.prototype, "availableSpace", {
        get: function () {
            ...
            var _a = tslib_1.__read((0, util_2.parseSeriesAttr)(padding), 4), top = _a[0], right = _a[1], bottom = _a[2], left = _a[3];
    ...
    Slider.prototype.renderTrack = function (container) {
        ...
        this.trackShape = (0, util_2.select)(container)
            ...
            .styles(tslib_1.__assign(tslib_1.__assign({}, this.shape), style));
    };
    Slider.prototype.renderBrushArea = function (container) {
        ...
        this.brushArea = (0, util_2.select)(container)
            ...
            .styles(tslib_1.__assign({ fill: 'transparent', cursor: brushable ? 'crosshair' : 'default' }, this.shape));
    };
    ...
    Slider.prototype.renderSelection = function (container) {
        var _a = this.attributes, type = _a.type, selectionType = _a.selectionType;
    ...
    Slider.prototype.getHandleStyle = function (handleType) {
        var _a = this.attributes, showLabel = _a.showLabel, showLabelOnInteraction = _a.showLabelOnInteraction, orientation = _a.orientation;
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (0, util_2.superStyleProps)(this.getHandleIconStyle(), 'icon')), (0, util_2.superStyleProps)(tslib_1.__assign(tslib_1.__assign({}, this.getHandleLabelStyle(handleType)), textStyle), 'label')), handlePosition), { orientation: orientation, showLabel: internalShowLabel, type: handleType, zIndex: 3 });
    };
