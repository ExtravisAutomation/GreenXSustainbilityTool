...
var IconBase = /** @class */ (function (_super) {
    ...
    IconBase.prototype.renderBackground = function () {
        ...
        this.background.attr(tslib_1.__assign({ x: -halfSize, y: -halfSize, width: size, height: size }, backgroundStyle));
    };
...
var arrow = function (size, color) {
    ...
    return new shapes_1.Path({
        style: {
            fill: color,
            anchor: '0.5 0.5',
            path: "M ".concat(size, ",").concat(size, " L -").concat(size, ",0 L ").concat(size, ",-").concat(size, " Z"),
...
var Range = /** @class */ (function (_super) {
    ...
    Range.prototype.renderIcon = function () {
        var color = this.attributes.color;
        var _a = this, size = _a.iconSize, lineWidth = _a.lineWidth;
        var gap = lineWidth;
        (0, util_2.select)(this.icon)
...
var LineChart = /** @class */ (function (_super) {
    ...
    LineChart.prototype.renderIcon = function () {
        ...
        var _b = tslib_1.__read([-size / 2 + gap, size / 2 - gap * 2], 2), ox = _b[0], oy = _b[1];
        (0, util_2.select)(this.icon)
...
var BarChart = /** @class */ (function (_super) {
    ...
    BarChart.prototype.renderIcon = function () {
        ...
        var _b = tslib_1.__read([-size / 2 + gap * 2, size / 2 - gap], 2), ox = _b[0], oy = _b[1];
        (0, util_2.select)(this.icon)
            .maybeAppend('.coordinate', 'polyline')
            .styles({
            points: getCoordinatePoints(size),
...
var SpeedSelect = /** @class */ (function (_super) {
    ...
    SpeedSelect.prototype.renderIcon = function () {
        ...
        var _a = this.attributes.speed, speed = _a === void 0 ? 1 : _a;
        var inheritStyle = (0, util_1.omit)(this.attributes, ['x', 'y', 'width', 'height', 'size', 'color', 'speed']);
        var width = (0, util_1.clamp)(iconSize, 20, Infinity);
        var height = 20;
        var x = -width / 2;
        var y = -height / 2;
        var style = tslib_1.__assign(tslib_1.__assign({}, inheritStyle), { x: x, y: y, width: width, height: height, defaultValue: speed, bordered: false, showDropdownIcon: false, selectRadius: 2, dropdownPadding: this.padding, dropdownRadius: 2, dropdownSpacing: iconSize / 5, placeholderFontSize: iconSize / 2, optionPadding: 0, optionLabelFontSize: iconSize / 2, optionBackgroundRadius: 1, options: [
                { label: '1x', value: 1 },
...
var ToggleIcon = /** @class */ (function (_super) {
    ...
    ToggleIcon.prototype.render = function () {
        var _this = this;
        var _a = this.attributes, x = _a.x, y = _a.y, onChange = _a.onChange, restStyles = tslib_1.__rest(_a, ["x", "y", "onChange"]);
        (0, util_2.select)(this.icon)
            .selectAll('.icon')
