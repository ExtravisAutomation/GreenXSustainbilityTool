import type { Chart, DodgeXTransform, NormalizeYTransform, SortByTransform, StackYTransform, Mark, Composition, AxisComponent, LegendComponent } from '@antv/g2';
...
export type Options = Spec & BaseOptions & {
    /**
     * @title 嵌套 view
