...
// @ts-expect-error
import { Text, Polygon } from '@antv/g';
...
var ConversionTag = /** @class */ (function () {
    ...
    ConversionTag.prototype.drawConversionTag = function () {
        ...
        conversionLayout.forEach(function (layout) {
            ...
            var text = new Text({
                style: __assign({ x: x, y: y, text: isFunction(formatter) ? formatter(prev, next) : ((next / prev) * 100).toFixed(2) + '%', fontSize: 12, textBaseline: 'middle', textAlign: 'center', fill: '#000' }, textStyle),
            });
