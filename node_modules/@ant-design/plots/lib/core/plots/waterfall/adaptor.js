...
function adaptor(params) {
    ...
    var transformData = function (params) {
        ...
        data.reduce(function (prev, cur, index) {
            ...
            if (index === 0 || cur.isTotal) {
                ...
                cur[constants_1.END_KEY] = cur[yField];
                cur[constants_1.WATERFALL_VALUE] = cur[yField];
            }
            else {
                var start = (_a = prev[constants_1.END_KEY]) !== null && _a !== void 0 ? _a : prev[yField];
                cur[constants_1.START_KEY] = start;
                cur[constants_1.END_KEY] = start + cur[yField];
    ...
    return (0, utils_1.flow)(transformData, link, utils_1.transformOptions, components_1.mark)(params);
}
