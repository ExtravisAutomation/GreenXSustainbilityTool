...
function getTransformData(data, field, xField, isSort) {
    ...
    var transformData = (0, utils_1.map)(data, function (d) {
        ...
        return _a = {}, _a[xField] = d[xField], _a[field] = fieldData, _a;
    }).flat();
...
function adaptor(params) {
    ...
    var cfgAdaptor = function (params) {
        ...
        params.options.children = [range, measure, target].map(function (c, i) { return (0, utils_1.deepAssign)(children[i], c); });
        return params;
    };
    return (0, utils_1.flow)(init, layoutAdaptor, cfgAdaptor, components_1.coordinateLayout, utils_1.transformOptions)(params);
}
