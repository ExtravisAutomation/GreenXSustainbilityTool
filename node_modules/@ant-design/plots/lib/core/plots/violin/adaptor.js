...
function adaptor(params) {
    ...
    var customTransform = function (params) {
        ...
        if (options.violinType === 'polar') {
            (0, utils_1.set)(options, 'coordinate', { type: 'polar' });
        }
        // 底层不消费violinType字段。
        (0, utils_1.set)(options, 'violinType', undefined);
        return params;
    };
    return (0, utils_1.flow)(customTransform, utils_1.transformOptions, components_1.mark)(params);
}
