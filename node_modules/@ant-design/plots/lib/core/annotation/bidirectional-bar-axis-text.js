...
var BidirectionalBarAxisText = /** @class */ (function () {
    ...
    BidirectionalBarAxisText.prototype.getElementsLayout = function () {
        ...
        return isVertical ? (0, utils_1.uniqBy)(elementsLayout, 'x') : (0, utils_1.uniqBy)(elementsLayout, 'y');
    };
    BidirectionalBarAxisText.prototype.getBidirectionalBarAxisTextLayout = function () {
        ...
        var textPath = ['title'];
        var textLayout = [];
        var _a = (0, utils_1.get)(this.views, [0, 'layout']), viewWidth = _a.width, viewHeight = _a.height;
    ...
    BidirectionalBarAxisText.prototype.drawBidirectionalBarAxisText = function () {
        ...
        axisLayout.forEach(function (layout) {
            ...
            var textNode = new g_1.Text({
                style: __assign({ x: x, y: y, text: (0, utils_1.isFunction)(labelFormatter) ? labelFormatter(text) : text, fontSize: 12, textBaseline: 'middle', textAlign: 'center', fill: '#000', wordWrap: true, wordWrapWidth: viewLayout === 'horizontal' ? constants_1.VERTICAL_MARGIN * 2 : 120, maxLines: 2, textOverflow: 'ellipsis' }, _this.transformLabelStyle(textStyle)),
            });
