...
var Plot = /** @class */ (function (_super) {
    ...
    function Plot(container, options) {
        ...
        _this.options = (0, utils_1.merge)({}, _this.getBaseOptions(), _this.getDefaultOptions(), options);
        _this.createG2();
        _this.bindEvents();
        return _this;
    }
    ...
    Plot.prototype.getChartOptions = function () {
        ...
        return __assign(__assign({}, (0, utils_1.pick)(this.options, constants_1.CHART_OPTIONS)), { container: this.container, width: width, height: height, autoFit: autoFit });
    };
    /**
     * G2 options(Spec) 配置
     */
    Plot.prototype.getSpecOptions = function () {
        ...
        return (0, utils_1.deleteCustomKeys)((0, utils_1.omit)(this.options, constants_1.CHART_OPTIONS), true);
    };
    /**
     * 创建 G2 实例
     */
    Plot.prototype.createG2 = function () {
        ...
        this.chart = new g2_1.Chart(this.getChartOptions());
    ...
    Plot.prototype.annotations = function () {
        ...
        constants_1.ANNOTATION_LIST.forEach(function (annotation) {
            ...
            if (annotationOptions) {
                ANNOTATION_MAP.set(key, new annotation_1.Annotaion[shape](_this.chart, annotationOptions));
            }
        });
    };
    /**
    ...
    Plot.prototype.updateOption = function (options) {
        this.options = (0, utils_1.merge)({}, this.options, options);
    };
    /**
     * 更新数据
     * @override
    ...
    Plot.prototype.execAdaptor = function () {
        ...
        adaptor({
            chart: this.chart,
            options: (0, utils_1.deleteChartOptionKeys)(this.options),
        });
    };
    /**
     * 当图表容器大小变化的时候，执行的函数
