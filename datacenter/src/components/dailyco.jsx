...
function dailyco(props) {
  ...
  return (
    <div  >
      ...
      <p style={{color:"#e5e5e5", padding:"0px 0px 10px 60px", margin:"0px "}}>About 80% of your Energy this month came from low-carbon sources on average, with solar making up the majority</p>
 ...
 <div
  ...
  >
    ...
    >
      {/* Main image */}
      <img src={uaerealmap} alt="UAE Map" width={760} height={450} style={{ top: "50" }} />
