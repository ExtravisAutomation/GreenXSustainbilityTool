  ...
  return (
    ...
    >
      <Row>
        ...
        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue label="End Of HW Life" value={data.data.endOfHWLife} />
        </Col>

        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue label="End Of HW Sale" value={data.data.deviceName} />
        </Col>

        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue label="End Of SW Life" value={data.data.endOfSWLife} />
        </Col>

        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue label="End Of SW Sale" value={data.data.endOfSWSale} />
        </Col>
        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue
            label="HardwarecVersion"
            value={data.data.hardwareVersion}
          />
        </Col>
        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
        ...
        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue label="Modified By" value={data.data.modifiedBy} />
        </Col>
        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
        ...
        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue
            ...
            value={data.data.onboardingDate}
          />
        </Col>

        <Col xs={24} sm={12} md={8} lg={6} style={{ padding: "10px" }}>
          <LabelledValue label="PN Code" value={data.data.pnCode} />
        </Col>
