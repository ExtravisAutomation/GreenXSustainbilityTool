...
{/* image part */}
    ...
    //     <div style={{display:"flex", alignItems:"center", width:"80px", height:"40px", borderRadius:"8px"}}>Rack-A</div>
    //     </div>
    ...
    //     <div style={{display:"flex", alignItems:"center", width:"80px", height:"40px", borderRadius:"8px"}}>DXB-CI-N9K-001</div>
    //     </div>
    //     <div style={{padding:"10px"}}>
    //     <label style={{fontWeight:"bold"}}>Status</label>
    //     <div style={{display:"flex", alignItems:"center",padding:"2px 10px",marginTop:"5px", borderRadius:"20px",backgroundColor:"#0490E7"}}>Active</div>
    //     </div>
    //     <div style={{padding:"10px"}}>
    //     <label style={{fontWeight:"bold"}}>Status</label>
    //     <div style={{display:"flex", alignItems:"center",padding:"2px 10px",marginTop:"5px", borderRadius:"20px",backgroundColor:"#0490E7"}}>Active</div>
    //     </div>
    //     {/* <div style={{padding:"10px",minWidth:"30%",paddingLeft:"50px", border:'2px solid red'}}>
    ...
    //     <div style={{display:"flex", alignItems:"center",padding:"2px 10px",marginTop:"5px", borderRadius:"7px",backgroundColor:"#0490E7"}}>60%</div>
    //     </div>
    ...
    //     <div style={{display:"flex", alignItems:"center",paddingLeft:"20px",  width:"80px", height:"40px", borderRadius:"8px"}}>1.8 W/Gbps</div>
    //     </div>
    //     </div>
