        ...
        <div style={{color:"#e5e5e5", maxWidth:"100%"}}>
          ...
          <tbody>
            <tr>
              ...
              <td style={cellStyle}>Rack <br/> Rack-B</td>
              <td style={cellStyle}>Position <br/> Front</td>
           
            </tr>
            <tr>
            <td style={cellStyle}>Device Type <br/><span style={spanblue}>WS-C3750V2-24PS-E</span> </td>
            <td style={cellStyle}>Description <br/><span style={spanblue}>DXB-CI-3750-001 </span></td>
            <td style={cellStyle}>Status <br/><span style={{backgroundColor:"rgb(165, 0, 0)", padding:"2px 10px", borderRadius:"20px"}}>ACTIVE</span> </td>
            ...
            <tr>
            <td style={cellStyle}>Cost <br/> AED 95
    </td>
            <td style={cellStyle}>Traffic <br/> 45 Gb/s
    </td>
            <td style={cellStyle}>Bandwidth <br/> 20%
    </td>
            <td style={cellStyle}>PCR <br/> 1.0 W/Gbps
    </td>
            </tr>
          </tbody>
        </table>
    ...
    //         <div style={{display:"flex", alignItems:"center", width:"80px", height:"40px", borderRadius:"8px"}}>Rack-B</div>
    //         </div>
    ...
    //         <div style={{display:"flex", alignItems:"center", height:"40px", borderRadius:"8px", color:"#0490E7"}}>WS-C3750V2-24PS-E</div>
    //         </div>
    //         <div style={{padding:"10px",minWidth:"30%"}}>
    //         <label style={{fontWeight:"bold"}}>Description</label>
    //         <div style={{display:"flex", alignItems:"center", width:"80px", height:"40px", borderRadius:"8px"}}>DXB-CI-3750-001</div>
    //         </div>
    //         <div style={{padding:"10px"}}>
    //         <label style={{fontWeight:"bold"}}>Status</label>
    //         <div style={{display:"flex", alignItems:"center",padding:"2px 10px",marginTop:"5px", borderRadius:"20px",backgroundColor:"rgb(122, 8, 2)"}}>Active</div>
    //         </div>
    //         <div style={{padding:"10px",minWidth:"30%",paddingLeft:"50px"}}>
    //         <label style={{fontWeight:"bold", paddingLeft:"20px"}}>Serial No.</label>
    //         <div style={{display:"flex", alignItems:"center",paddingLeft:"20px",  width:"80px", height:"40px", borderRadius:"8px"}}>FCW2152D1JE</div>
    //         </div>
    //         </div>
    ...
    //         <div style={{display:"flex", alignItems:"center",padding:"2px 10px",marginTop:"5px", borderRadius:"7px",backgroundColor:"rgb(122, 8, 2)"}}>90%</div>
    //         </div>
    ...
    //         <div style={{display:"flex", alignItems:"center", width:"80px", height:"40px", borderRadius:"8px"}}>45 Gb/s</div>
    //         </div>
    //         <div style={{padding:"10px"}}>
    //         <label style={{fontWeight:"bold"}}>Bandwidth</label>
    //         <div style={{display:"flex", alignItems:"center",padding:"2px 10px",marginTop:"5px", borderRadius:"20px"}}>20%</div>
    //         </div>
    //         <div style={{padding:"10px",minWidth:"30%",paddingLeft:"50px"}}>
    //         <label style={{fontWeight:"bold", paddingLeft:"20px"}}>PCR</label>
    //         <div style={{display:"flex", alignItems:"center",paddingLeft:"20px",  width:"80px", height:"40px", borderRadius:"8px"}}>1.0 W/Gbps</div>
    //         </div>
    //         </div>
